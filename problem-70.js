/*
আরে কটা ফাংশন লি খবে যে টার নাম লি খবে । যে ই ফাংশনে র নাম হবে paperRequirements
...
বলে দিবে ত োমার সর্বম োট কতপৃষ্ঠা কাগজ লাগবে ।
উত্তর হিসেবে সংখ্যা রি টার্ন করবে ।
*/
...
function paperRequirements(firstBookCopy,SecondBookCopy,ThirdBookCopy) {
    ...
    totalPage = firstBookCopy*firstBookPage+secondBookPage*SecondBookCopy+thirdBookPage*ThirdBookCopy
    return totalPage
}
